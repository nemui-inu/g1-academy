  ...
  <div class="d-flex flex-row gap-3">
    ...
    <div class="d-flex flex-column gap-3">
      ...
      <div class="d-flex flex-column gap-4 bg-white shadow-sm rounded-3 p-3">
        <img src="public/img/admin.jpg" class="rounded-1" alt="" style="width: 240px; ">
        <div>
    ...
    <div class="d-flex flex-column gap-3 w-100">
      <p class="mb-0 text-navy fw-bold" style="font-size: 20px;">Tasks</p>
      <div class="d-flex flex-column gap-3 bg-white shadow-sm rounded-3 p-5 align-items-center">
        <p class="mb-0 text-navy">No tasks assigned yet.</p>
      </div>
    </div>
  </div>
</div>
